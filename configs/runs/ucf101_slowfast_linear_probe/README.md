...
```bash
uv run python -m src.pipeline.extract --run-config configs/runs/ucf101_slowfast_linear_probe/ucf101_slowfast_c50_heldout_rgb_quantization_low.json
uv run python -m src.pipeline.extract --run-config configs/runs/ucf101_slowfast_linear_probe/ucf101_slowfast_c50_heldout_rgb_quantization_mid.json
uv run python -m src.pipeline.extract --run-config configs/runs/ucf101_slowfast_linear_probe/ucf101_slowfast_c50_heldout_rgb_quantization_high.json
uv run python -m src.pipeline.extract --run-config configs/runs/ucf101_slowfast_linear_probe/ucf101_slowfast_c50_heldout_solarization_low.json
uv run python -m src.pipeline.extract --run-config configs/runs/ucf101_slowfast_linear_probe/ucf101_slowfast_c50_heldout_solarization_mid.json
uv run python -m src.pipeline.extract --run-config configs/runs/ucf101_slowfast_linear_probe/ucf101_slowfast_c50_heldout_solarization_high.json
```
